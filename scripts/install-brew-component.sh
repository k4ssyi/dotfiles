...
brew install git vim neovim tmux direnv jq wget ghq tree coreutils curl gpg gawk mas reattach-to-user-namespace lsd starship ripgrep tig jesseduffield/lazygit/lazygit gh
